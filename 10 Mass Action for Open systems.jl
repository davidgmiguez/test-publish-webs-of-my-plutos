...
# ╔═╡ cdc21333-8780-401c-af85-8db3084c56ee
using DifferentialEquations

# ╔═╡ 141f3c82-e7c0-4666-b843-71f32bcc7324
...
# ╔═╡ ef6f5302-8b63-11ec-38cb-dd13e47b9588
md"# Open Systems and Nonlinear Interactions
...
begin
	...
	md"""
	**Use the slider to set the initial conditions**
...
md"Another simple example is the generation of a given reactant in the system, such as:
```math
...
# ╔═╡ 1e162c6f-53f3-4db5-b974-3b44739b3242
md"""
X_{1}(0)= $(👍)
"""

# ╔═╡ 0877a1b9-a54f-4b8d-97fd-3669338029ff
begin
	X₀[1] = 👍
...
# ╔═╡ a1217f40-d780-4394-a406-d83d6e4a37a6
md"Let's now explore some special cases of open systems that look in principle very similar to the previous one:
...
# ╔═╡ 7d840f24-e0b6-4722-b49a-3212644827d5
begin
...
# ╔═╡ 81f78df6-dd79-4427-8bb3-b109101deb73
md"""
X_{1}(0)= $(🟥)
"""

# ╔═╡ f33f8248-4f04-4b4f-b061-455d148e7de6
begin
	X₀[1] = 🟥
	#k_1 = 0.1
