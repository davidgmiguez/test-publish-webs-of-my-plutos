...
# ╔═╡ e527d871-3b0e-4bc6-ac80-cf3f9c67a794
using DifferentialEquations

# ╔═╡ 65434c34-8073-45b2-8a07-7a35f4df9214
using ParameterizedFunctions

# ╔═╡ cb631358-60c6-437e-bf29-37abd69c16e2
using PlutoUI

# ╔═╡ 53837fab-f211-4b61-b568-f0249b45b78d
using HypertextLiteral

# ╔═╡ 533a59ad-d026-4312-a20b-b5ece2269e62
md" ## 4. Matrix Formulation for systems of interactions
...
md" To learn how to write reversible reactions as a matrix form, let's practice with the following reaction:
...
# ╔═╡ 7178eabf-b4bc-439a-b6c5-86fcf5c7ebef
@htl("""
...
currentScript.previousElementSibling.innerText = "Computer Task 2: Write a function to take as input the matrices A and B corresponding to the reaction 30 and returns the value (B-A)' "
...
# ╔═╡ e4a6d196-0fe9-4510-ab44-667221cfc995
@htl("""
...
<script>
// more about selecting elements later!
currentScript.previousElementSibling.innerText = "Solution Computer Task 2"
...
# ╔═╡ 203851ad-52d4-4554-bc24-05bdad952ae6
function Calculate_BA_transpose(A,B)
    return (B-A)'
end
...
# ╔═╡ a15dea76-b7e9-49e7-9b04-5ec301bfc6d2
Calculate_BA_transpose(A,B)

# ╔═╡ b664a7e5-1218-41cb-92dc-5c00ecd85915
md"## 5. Order of a reaction and units of the rate constants


In this general formulation, we can directly know,  the order of a given reaction $i =1…r$ as:
...
Print("The order of the 1st reaction is $(sum(A[1]))")

# ╔═╡ 899739cc-fe85-45b2-8e62-104335e839f1
Print("The order of the 2st reaction is $(sum(A[2]))")

# ╔═╡ 57381f59-0f71-4136-93e8-95102760281d
Print("The Units of k1 are s^-1 . k^$(1-(sum(A[1])))")

# ╔═╡ b1255e2a-43ee-40be-a8a9-fc9d2f813b3a
Print("The Units of k2 are s^-1 . k^$(1-(sum(A[2])))")

# ╔═╡ a51fdc58-4e7b-4f20-933f-403bdb9ae541
@htl("""
...
<script>
// more about selecting elements later!
currentScript.previousElementSibling.innerText = "Computer Task 3: B-A'"
...
# ╔═╡ aaec1bd4-bca5-46db-9ab8-2a1921cd610f
md" Generalize the funcion developed for 'Computer Task 2' to account any reaction, i.e., to take as input reactions with an arbitrary number of reactants and reactions (set by the size of matrices A and B).

Update the function to show also as output the order of each reaction, the units of each of the rate constants, and the matrix (B-A)'. "

# ╔═╡ 89b43a03-1229-4c82-af07-85a7fbec5b7e
@htl("""
...
<script>
// more about selecting elements later!
currentScript.previousElementSibling.innerText = "Solution Computer Task 3"
...
# ╔═╡ dec49b7a-9a5e-43aa-ae4a-450643809b66
md"""*Task 1*

`Value of equilibrium Constant = ` $(@bind K_eq1 html"<input type=text >")

`Value of concetration of HI= ` $(@bind HI html"<input type=text >")

`Value of concentration of I2= ` $(@bind I2 html"<input type=text >")

	"""

# ╔═╡ 913e242a-7364-4589-bb29-a1fd26e4a7dd
	H2_task1=round((parse(Float64, HI))^2 / parse(Float64, K_eq1)*parse(Float64, I2),sigdigits=2)

# ╔═╡ ce663698-1b2e-4002-b014-6cf2961e0e3e
md"""*Task 2*

`Value of equilibrium Constant = ` $(@bind K_eq2 html"<input type=text >")

`Value of concetration of N2= ` $(@bind N2 html"<input type=text >")

`Value of concentration of NH3= ` $(@bind NH3 html"<input type=text >")

	"""

# ╔═╡ 3fabcd7d-db29-4f10-b2d8-b5d28e806ad7
H2_task2=round(((parse(Float64, NH3))^2 / (parse(Float64, K_eq2)*parse(Float64, N2)))^(1/3),sigdigits=3)

# ╔═╡ f4e391c8-8a12-4c0e-a6d0-3667426aaf14
# Task 2b
 Print("1. towards producs")

# ╔═╡ d7c1d683-cf0e-42aa-9449-09895fb81cb6
Print("2. towards reactants")

# ╔═╡ 88345e34-bc0d-4ef7-8f6b-dd4649e33062
Print("3. towards producs")
