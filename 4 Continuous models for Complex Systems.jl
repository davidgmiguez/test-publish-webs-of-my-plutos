...
# ╔═╡ a4dd8bdb-ef6c-4fd9-a134-f446c324d3f2
@htl("""
...
<script>
// more about selecting elements later!
currentScript.previousElementSibling.innerText = "Exercises: Calculate how long until a population doubles in size (N=2 N0)? :"
...
begin
	plot(K -> TTT * log2((K-20)/(K/2-20)),collect(40:1:100),label="T= $TTT",seriestype=:line,xlabel=("K"),ylabel=("t until K/2"),ylims = (0,60))
	hline!([TTT], label=" cell cycle")
end
...
Systems in biology need to be robust. As an embrio develops, the correct number of cells is key to ensure a proper form, shape and function of an organ. Nature has implemented several ways to enhance robustness against perturbations. 
...
# ╔═╡ 1da9c4f9-993c-4e79-8c03-cdc0f6de6066
